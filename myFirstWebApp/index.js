...
const loadData = (options) => {
  fetch(options.url).then(function(response){return response.json()})
    .then(function(data){ 
...
const App = (props) => {
  ...
  // Node.js React hooks
  let [query, setQuery] = useState("Planes");
...
ReactDOM.render(<App name="Gregorius Pierre Putra" emoji="Hello!"/>, document.getElementById("root"));
